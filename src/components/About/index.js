  ...
  return (
    <section className="aboutContent" id="aboutContent">
      ...
      <p className="aboutText">
          ...
          I find joy in the tension between form versus function, the big picture and the details and old versus new. Previously, I worked in costumes for film and television, studying the art of visual storytelling. On my free time, I love to cook, curate playlists, catch up on my favorite shows and dabble in pottery.
        </p>
      </div>
      <Navigation/>
    </section>
