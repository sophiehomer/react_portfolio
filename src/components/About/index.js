  ...
  return (
    ...
    <img src={aboutImage} className="aboutImg" style={{ width: "32%" }} alt="about" />
      <p className="aboutText">
        ...
        California. She worked in costumes for television and film for nearly ten years before pursing her dreams in web development and UI. Sophie resides in West Hollywood, California. She's passionate about music and cooking.
      </p>
